...
<Update label="4.7.43">
  ## Jul 23, 2026
  - Improved text [highlighting](/highlights)
  - Taps and gestures are now faster and more responsive thanks to native components
  - More reliable connection to the server
