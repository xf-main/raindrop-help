...
<Update label="5.4.8">
  ## Aug 13, 2026
  - Improved tags picker
  - Improved [highlighting](/highlights) performance on large documents
  - Improved files and photos upload reliability
  - The [Stella](/stella) button is now hidden when the AI assistant is turned off
  - Fixed a false positive error message that appeared when adding bookmarks via the **Add to Unsorted** action
  - Fixed rare crashes
  - Bug fixes
</Update>
...
<Update label="5.3.7">
  ## Mar 30, 2026
  - **Now available in 10 languages**: 🇺🇸 English 🇩🇪 Deutsch 🇯🇵 日本語 🇫🇷 Français 🇪🇸 Español 🇳🇱 Nederlands 🇧🇷 Português 🇵🇱 Polski 🇮🇹 Italiano 🇷🇺 Русский
  - Fixed a redundant background behind **Add to Unsorted** on iOS 26
