---
title: "Web app"
description: "Web, Desktop App & Browser Extensions"
icon: "laptop"
---

<Update label="5.8.2">
  ## Sep 11, 2026
  - **AI suggestions** for tags and collections are now much faster (under a second) and better follow your letter casing and preferred language.
  - [Stella](/stella) improvements:
    - Chat about a page right after saving it — no need to wait for the [web archive](/web-archive) or indexing to finish.
    - Much more stable — no more unknown errors or interruptions.
    - Now powered by a more capable model (DeepSeek 4.1 Flash).
    - Better chat titles.
  - [Search](/using-search) is now far more predictable: no difference between lowercase and uppercase, and exact match works as expected.
  - Fixed `match:OR` search.
  - Fixed search indexing lag — bookmark changes are usually searchable within a second.
  - Faster [highlighting](/highlights) on large pages and PDFs.
  - Improved favicon generation for some tricky domains.
  - Improved screenshot generation for JavaScript-heavy pages.
  - Fixed the "saved" indicator in the extension for URLs longer than 500 characters.
  - Fixed tags autocomplete showing a repeated "In collection" section.
  - Fixed Safari Profiles support in the extension — you now stay signed in.
  - Fixed web extension sizing on iPad mini.
</Update>

<Update label="5.7.7">
  ## Jun 2, 2026
  - <Icon icon="youtube" /> **YouTube transcripts** — transcripts are now extracted automatically from videos and saved to the [web archive](/web-archive), so they're [fully searchable](/using-search) and available to [Stella](/stella) for chatting about a video.
  - <Icon icon="twitter" /> **X.com (formerly Twitter) threads** are now saved in full as web archives and indexed for full-text search.
  - <Icon icon="reddit" /> **Reddit web archives** fixed — posts now save in full with comments and full-text search.
  - <Icon icon="bolt" /> New [Zapier integration](/integrations/zapier) — connect bookmarks with thousands of other apps.
  - **Semantic search** is back — previously disabled over quality issues, now much improved.
  - Overall improvements to web archive, with a higher success rate.
  - Stella is faster and more stable, and you can now approve all actions at once instead of one by one.
  - [MCP](/integrations/mcp) is now available on the Free plan too — only semantic search remains exclusive to paid plans.
  - Improved translations.
  - Double-clicking a collection in the sidebar now expands or collapses its nested collections.
</Update>
...
<Update label="5.7.2">
  ## Feb 21, 2026
  - OneDrive as additional automatic backup destination (in addition to Dropbox and Google Drive)
...
<Update label="5.7.0">
  ## Feb 5, 2026
  - **New ✦ AI Assistant (Stella)**: Click the **Ask** button to search by meaning, summarize articles, organize your library, and more — all powered by AI
  - Removed the AI Suggestions page — all AI features are now part of the assistant, which is more flexible and capable
</Update>
...
<Update label="5.6.50">
  ## Jul 23, 2024
  - Fix not working extension shortcuts in Edge browser
...
<Update label="5.6.3">
  ## May 14, 2024
  - **New ✦ AI Organization Tips (Pro Only)**: No need to sort your bookmarks right away. Whenever you find some free time, just pop over to the organization tips page. There, you'll discover ready-to-use tips for enhancing your bookmark organization
</Update>
...
<Update label="5.6.24">
  ...
  - **New Additional Search Operators**: `title:query`, `excerpt:query`, `note:query`
...
<Update label="5.6.20">
  ...
  - Faster thumbnail generation with additional servers in North America, Europe and Japan
  - Public page improvements: support open in new tab setting, support view customizations
  - Permanent copy improvements: use web archive copy when origin is not reachable, support some paywall websites, better website popups removal logic
  - Export / backup improvements: new 'id' and 'favorite' tabs in CSV
  - Desktop app: fix issue when close, maximize and minimize buttons overlap content
</Update>
...
<Update label="5.6.16">
  ## Oct 24, 2023
  - The quality of permanent copies has been significantly improved, particularly for webpages with heavy JavaScript. Webpage copies from Twitter now work perfectly as well.
...
<Update label="5.6.1">
  - Extension: revert back "tabs" permission to opt-in ("browser history" permission is now not required)
</Update>
...
<Update label="5.4.2">
  - Search is now 5x time faster
  - New advanced search operators: find exact phrase, exclude conditions, match any condition, search by date, find by URL part, find by permanent copy status, find only in title/description
  - Now it's possible to search by a part of a word
  - Recent searches
  - Extension: new overlay save page/link dialog that opens inline and auto-closes
  - Cover selector now shows 10 images from web-page
  - Significantly improved initial load time of extension popover
  - Significantly improved parser (especially for Youtube)
  - Safari: fix permissions dialog, show [✔] as badge, fix hotkeys visibility, hide omnibox option
...
<Update label="5.3.34">
  - New Share window: now you can add description and embed to website/blog
